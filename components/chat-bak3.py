...
def render_chat(supabase, gemini_client, chat_model_name, embedding_model_name):
    ...
    # This locks the chat history to a specific height so the input stays at the bottom
    ...
    # --- Custom Input Row (Locked below the chat) ---
    ...
    with input_container:
        ...
        with col2:
            ...
            # Changed language to 'zh-HK' for Cantonese
